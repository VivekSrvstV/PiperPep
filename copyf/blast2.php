...
<P>-->
    <!--<a href="docs/blast_program.html">Program</a>-->
       <center><h2><font size="4" color ="white"><b>NCBI nt Blast</b></font></h2></center>
        <center><font size=3 color='white'>Blast your target sequence against NCBI nt database</font></center>
...
<input type="hidden" name="DATALIB" value="nt">
</body>
<!--
