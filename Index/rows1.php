...
><left>".$row[1]."</td><td><a href=\"browse.php?by=$row[2]&TYPE=GENE/LOCUS\" rel=".$row[2]."5>$row[2]</a></td><td>".$row[4]."</td><td><center>".$row[8]."</center></td><td><center>".$row[11]."</a></center></td><td><center>".$row[12]."</center></td><td><center>".$row[13]."</center></td>";

if (preg_match("/US/", "$row[23]")) {

echo"<td><center><a href=\"http://www.patentlens.net/patentlens/patents.html?patnums=".$row[23]."\" rel=".$row[0].">".$row[23]."</center></a></td>";}
