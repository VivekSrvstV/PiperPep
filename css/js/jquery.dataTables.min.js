...
a + ""; a = b.split(""); var c = ""; b = b.length; for (var d = 0; d < b; d++) { if (d % 3 === 0 && d !== 0) c = "," + c; c = a[b - d - 1] + c } 
            ...
            }; this.aLengthMenu = []; this.bDrawing = this.iDraw = 0; this.iDrawError = -1; this._iDisplayLength = 10000; this._iDisplayStart = 0; this._iDisplayEnd = 100000; this._iRecordsDisplay = this._iRecordsTotal = 0; this.bJUI = false; this.oClasses = n.oStdClasses; this.bSorted = this.bFiltered = false; this.oInit = null
        } function r(a) {
            return function () {
